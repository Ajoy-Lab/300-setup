...
%     pulse_name = ['init_pul', 'theta1', 'gamma', 'theta2'];
    ...
    lengths = [49.4e-6 49.4e-6 49.4e-6 49.4e-6 49.4e-6 49.4e-6];
    ...
    repeatSeq = [1 1 1]; % how ma54ny times to repeat the block of pulses
                ...
                defPulse('gamma1', amps(3), mods(3), lengths(3), phases(3), spacings(3));
                defPulse('theta2', amps(4), mods(4), lengths(4), phases(4), spacings(4));
                defPulse('gamma2', amps(5), mods(5), lengths(5), phases(5), spacings(5));
                defPulse('theta3', amps(6), mods(6), lengths(6), phases(6), spacings(6));
                defBlock('pulsed_SL', {'init_pul','theta1'}, reps(1:2), markers(1:2), trigs(1:2));
                defBlock('1st_y_pulse_then_SL', {'gamma1','theta2'}, reps(3:4), markers(3:4), trigs(3:4));
                defBlock('2nd_y_pulse_then_SL', {'gamma2','theta3'}, reps(5:6), markers(5:6), trigs(5:6));
                makeBlocks({'pulsed_SL','1st_y_pulse_then_SL', '2nd_y_pulse_then_SL'}, ch, repeatSeq);
...
%                 numberOfPulses_total = reps(2);
                numberOfPulses_total = reps(2)+reps(4)*repeatSeq(2) + reps(6)*repeatSeq(3);
