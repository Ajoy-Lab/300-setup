...
%     pulse_name = ['init_pul', 'theta1'];
    ...
    % cmdBytes(2) corresponds to pw
    % start index at 0!
    index = cmdBytes(2);
    offset_values = 0:100:7700;
    pw_values = [32e-6 35e-6 38e-6 41e-6];
    offset_index = mod(index,78)+1;
    pw_index = fix(index/78) + 1;
    
    offset = offset_values(offset_index);
    pw = pw_values(pw_index);
