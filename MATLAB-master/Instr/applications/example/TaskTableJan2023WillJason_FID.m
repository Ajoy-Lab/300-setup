...
%                 'chunks' % irrelevant for FID --> loops=1
                 ...
                 rc = inst.SendScpi(sprintf(':DIG:ACQ:FRAM:DEF %d, %d',numberOfPulses*loops, 2 * sampleWindow));
                 assert(rc.ErrCode == 0);
        ...
        %                 toc                
                ...
                netArray = NET.createArray('System.UInt16', 4*sampleWindow*numberOfWindows); %total array in one dimension -- all memory needed
