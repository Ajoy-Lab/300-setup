...
measurementTimeSeconds = 12; %Integer
...
%         cmdBytes = fread(u2);
        ...
        [tempBytes,dataBytes]=strtok(readBytes,',');
...
%                 numberOfPulses = 2717*4; % 1 second of pulses
            ...
            %    plot(time_axis,(pulseAmp),'b-');hold on;
                ...
                fn = sprintf('FID_DATA_%s.mat', datestr(now,'mm-dd-yyyy HH-MM'));
                % Save data
