...
%                 pw = cmdBytes(2)*1e-6
                ...
                readLen = 33888; % 16896 %round2((tacq+2)*1e-6/1e-9,96)-96 %constraint: has to be multiple of 96, add 4 of deadtime %number of points in a frame
            ...
            case 3 % Measure
                ...
                for n = 1:loops
                    ...
                    if savesinglechunk
                        if  n==8 %determines which chunk will be saved
                            pulsechunk = int16(pulses);
                            a = datestr(now,'yyyy-mm-dd-HHMMSS');
                ...
                delay2 = 0.000003; % dead time the unknown one
                
                time_cycle=pw+(tacq+2+4+2)*1e-6+delay2;
