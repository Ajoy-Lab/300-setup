...
try
    ...
    %numberOfFrames = 543*2; % 0.5 second
    ...
    tic
    pulseAmp = [];
    dF = sampleRate/readLen;
    f = -sampleRate/2:dF:sampleRate/2-dF;
        
    for i = 1:numberOfFrames
        clear samples samplesMean samplesDC
        i
        ...
        X = fftshift(fft(samplesDC(1:readLen)));
        pulseAmp(i) = max(abs(X(18669:18671))/readLen); 
    end
    fprintf('End Read\n');
