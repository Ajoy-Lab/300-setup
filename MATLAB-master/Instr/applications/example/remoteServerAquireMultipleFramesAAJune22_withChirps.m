...
%                     end
            ...
            case 6 % Program MW chirp waveform
                ...
                % select segment 1 as the the programmable segment
...
%                 THINK OF A MIXER, BUT DIGITAL
            ...
            case 7 % Play MW chirp waveform (segment 1)
            ...
            case 8 % Disable MW chirp output
            ...
            case 9 % Flip direction of MW frequency sweep (segment 2)
